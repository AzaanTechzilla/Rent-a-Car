...
<div className="">
  ...
  <CardContent className='flex items-center justify-center p-6'>
    <div className="h-[40vh] md:h-[60vh] flex justify-center items-center flex-col relative">
      <h3 className="mb-1 lg:mb-5 flex items-center gap-6 text-2xl lg:text-5xl">
        <span  className="text-third-color font-bold transition-[3s]">{items.title}</span>
      </h3>
      <p className="text-white text-sm md:text-4xl text-center w-10/12 md:w-8/12">
      <i className={"fad fa-" + items.icon}></i>
