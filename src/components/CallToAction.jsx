...
const CallToAction = () => {
  return (
    <>
      <div className="w-full grid grid-cols-1 md:grid-cols-2 rounded-lg shadow-[0_2px_15px_-3px-rgba(0,0,0,0.07),0_10px_20px_-2px-rgba(0,0,0,0.04)] md:flex-row relative flex-col">
        <img
          src="/lower-banner.jpg"
          alt=""
          className="h-96 w-full rounded-t-lg object-cover md:h-[60vh] lg:h-[80vh] md:!rounded-l-lg"
        />
        <div className="flex flex-col justify-center gap-8 md:px-16 px-8 md:my-0 my-8">
          <div className="flex items-center  gap-5">
            ...
            <div className="flex  flex-col gap-2">
              ...
              <p className="mb-4 text-base text-gray-500 border-l-4 border-third-color pl-4">
                Seeking Wedding Transportation Services? Contact Us to Custimize
                Your Special Day!
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center  gap-5">
            ...
            <div className="flex  flex-col gap-2">
              ...
              <p className="mb-4 text-base text-gray-500 border-l-4 border-third-color pl-4">
               Discover Unmatched Luxury Travel with Limolux in Melbourne's Frinest Experience
              </p>
            </div>
          </div>
        </div>
